...
class Step3 extends React.Component {
    ...
    render() {
        return (
            ...
            <div className="row">
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('size', 'small')}>
                    <img src="https://i.imgur.com/NH9FtGH.png" alt="" style={{width:100, height:100}}/>
                </div>
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('size', 'medium')}>
                    <img src="https://toolkit.climate.gov/sites/default/files/ecosystem_icon.png" alt="" style={{width:100, height:100}}/>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('size', 'large')}>
            ...
            <div className="row">
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('expertiseLevel', 'beginner')}>
                    <img src="http://static.pokemonpets.com/images/monsters-images-300-300/1-Bulbasaur.png" alt="" style={{width:100, height:100}}/>
                </div>
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('expertiseLevel', 'intermediate')}>
                    <img src="https://cdn.staticneo.com/w/pokemon/8/86/Ivysaur.png" alt="" style={{width:100, height:100}}/>
                </div>
                <div className="Step3-Options col-md-4" onClick={() => this.props.handleSelection('expertiseLevel', 'expert')}>
