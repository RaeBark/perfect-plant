            ...
            <React.Fragment>
                ...
                <div>
                    <div className="Step1 row">
                        <div className="Step1-Options hvr-float-shadow col" onClick={() => this.props.handleSelection('maintenance', 'low')}>
                            <img class="Option" src="https://i.imgur.com/C58KDmg.png" alt="" style={{width:100, height:100}}/><br/>
                            <label>low</label>
                        </div>

                        <div className="Step1-Options hvr-float-shadow col" onClick={() => this.props.handleSelection('maintenance', 'medium')}>
                        ...
                        <div className="Step1-Options hvr-float-shadow col" onClick={() => this.props.handleSelection('maintenance', 'high')}>
                            <img src="https://i.imgur.com/C58KDmg.png" alt="" style={{width:100, height:100}}/>
                            <img src="https://i.imgur.com/C58KDmg.png" alt="" style={{width:100, height:100}}/>
                            <img src="https://i.imgur.com/C58KDmg.png" alt="" style={{width:100, height:100}}/><br/>
                            <label>high</label>
                ...
                <div className="row">
                    <div className="Step1-Options Sunlight hvr-float-shadow col" onClick={() => this.props.handleSelection('sunlight', 'none')}>
                    ...
                    <div className="Step1-Options Sunlight hvr-float-shadow col" onClick={() => this.props.handleSelection('sunlight', 'parsed')}>
                    ...
                    <div className="Step1-Options Sunlight hvr-float-shadow col" onClick={() => this.props.handleSelection('sunlight', 'direct')}>
